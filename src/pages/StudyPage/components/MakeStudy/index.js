        ...
        return <div id="MakingStudy">
            <form method="post" onSubmit={this.handleSubmit}>
                <div class="StudyInfo">
                    ...
                    <div class="StudyMember"><input id="StudyMember" type="number" min="2" max="20" name="maxSeat" placeholder="스터디 정원"required onChange={event => this.handleChange(event)}/></div>
                </div>
